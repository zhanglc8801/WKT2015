...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , savePath: ['/UploadFile/SiteContent/Images']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        , toolbars:[
            ['bold', 'italic', 'underline', 'strikethrough', 'fontborder', 'forecolor', 'superscript', 'subscript', 'fontfamily', 'fontsize','justifyleft','justifycenter','justifyright','justifyjustify','link', 'unlink', 'insertimage', 'source', 'fullscreen']
        ]
