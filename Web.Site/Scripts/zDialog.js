...
* zDialog 2.0
**/
var IMAGESPATH = '/Content/img/dialog/'; //图片路径配置
/*************************一些公用方法和属性****************************/
...
var $topWindow = function () {
    ...
    while (parentWin != parentWin.parent && 1 == 2) {
...
Dialog.prototype.create = function () {
    ...
    var html = '<table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" class="yui3-overlay-content yui3-widget-stdmod" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">' +
    '<tr id="_Draghandle_' + this.ID + '" class="yui3-widget-hd" style="' + (this.Drag ? "cursor: move;" : "") + '">' +
      '<td height="28"><div class="title"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>' +
        '<a class="close closebtn" style="cursor:pointer" onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"><i title="关闭" class="shutdown"></i></a></td>' +
    '</tr>' +
    '<tr valign="top">' +
      '<td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="margin-top:3px;">' +
