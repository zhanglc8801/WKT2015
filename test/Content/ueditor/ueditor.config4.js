...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['bold', 'italic', 'underline', 'strikethrough', 'fontborder', 'forecolor', 'superscript', 'subscript', 'fontfamily', 'fontsize','justifyleft','justifycenter','justifyright','justifyjustify','link', 'unlink']
        ]
