...
namespace WKT.Service.Interface
{
    public interface IIssueService
    {
        ...
        /// <param name="setID"></param>
        /// <returns></returns>
        ExecResult DelYearVolume(Int64[] setID);
        ...
        /// <param name="setID"></param>
        /// <returns></returns>
        ExecResult DelIssueSet(Int64[] IssueSetID);
        ...
        /// <returns></returns>
        ExecResult DelIssueContent(Int64[] contentID);
        ...
        /// <param name="ReferenceID"></param>
        /// <returns></returns>
        ExecResult DelIssueSubscribe(Int64[] subscribeID);
