...
{
    public partial interface IJournalSetInfoBusiness
    {       
        #region 获取一个实体对象
        ...
        /// <returns></returns>
        int GetMaxID(long JournalID, string DBName, string TableName);
        ...
        /// <returns></returns>
        string GetMaxID(long JournalID, string DBName, string TableName, int Num);
    }
}
