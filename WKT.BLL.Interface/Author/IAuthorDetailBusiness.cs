...
{
    public partial interface IAuthorDetailBusiness
    {       
        #region 获取一个实体对象
        ...
        /// <returns></returns>
        bool SaveAuthor(AuthorDetailEntity model);
        ...
        /// <param name="AuthorID"></param>
        /// <returns></returns>
        bool DelAuthorDetail(Int64[] AuthorID);
        ...
        /// <returns></returns>
        bool SetAuthorExpert(AuthorDetailQuery query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        bool CancelAuthorExpert(AuthorDetailQuery query);
        ...
        /// <returns></returns>
        bool SaveExpertGroupMap(IList<ExpertGroupMapEntity> list, Int32 ExpertGroupID, Int64 JournalID);
        #endregion
    }
}
