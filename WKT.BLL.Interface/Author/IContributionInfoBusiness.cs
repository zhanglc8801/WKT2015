...
{
    public partial interface IContributionInfoBusiness
    {
        #region 稿件信息
        ...
        /// <returns></returns>
        Int64 AuthorPlatform(ContributionInfoEntity model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        bool SaveFormat(ContributionInfoEntity model);
        ...
        /// <returns></returns>
        ContributionInfoEntity GetContributionInfo(Int64 cID);
        ...
        /// <returns></returns>
        bool ChangeStatus(ContributionInfoQuery query);
        ...
        /// <param name="cID"></param>
        /// <returns></returns>
        bool DelContributionInfo(Int64[] CID);
        ...
        /// <returns></returns>
        bool DraftContribution(RetractionsBillsEntity model);
        ...
        /// <param name="retractionsBillsEntity"></param>
        /// <returns></returns>
        bool AddRetractionsBills(RetractionsBillsEntity retractionsBillsEntity);
        ...
        /// <param name="trans"></param>
        /// <returns></returns>
        bool UpdateRetractionsBills(RetractionsBillsEntity retractionsBillsEntity);
